...
--SP_GetMissionList2 @searchTerm='dancing', @pageIndex=1, @pageSize=5
--SP_GetMissionList2 @searchTerm='india', @startDate = '2023-06-01', @endDate='2023-07-15', @minRating=3, @pageIndex=1, @pageSize=5
--EXEC SP_GetMissionList2 
...
BEGIN
    ...
    (
        ...
        WHERE (
                  ...
                  OR dbo.FN_GetMissionSkillsList(dbo.mission.mission_id) LIKE '%' + @searchTerm + '%'
