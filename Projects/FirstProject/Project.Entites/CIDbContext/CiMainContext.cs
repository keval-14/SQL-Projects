...
{
    public CiMainContext()
    {
    }

    public CiMainContext(DbContextOptions<CiMainContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141C24720B0");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C341DC010C9");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A882B21F88");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52A41A2A04");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687EEACA8E5");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055DDA57B7D");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favorite__94E4D8CAA29FECC8");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7269AD357");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB264174FA5");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838ADD3E8A7D");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED15827412741");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8E0621CB4");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E517200CCE21C");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___827120088D872737");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5ACEDC5F5BA");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA8379A9C96C54");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C56F562A256");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867B03EAFDF");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C5D5DBB02");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068F3A82F40");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__users__B9BE370FA802D804");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B955BBFCB");
